...
h2w_i = h1b_i + 32*32
h2b_i = h2w_i + 32
phenotype = np.split(genome, [h1w_i,h1b_i,h2w_i,h2b_i])
phenotype[0] = np.reshape(phenotype[0], (32, 32))
phenotype[2] = np.reshape(phenotype[2], (32, 32))
...
D_W2, D_b2, D_W3, D_b3 = [tf.multiply(tensor, tf.constant(mask)) for tensor, mask in zip([D_W2, D_b2, D_W3, D_b3], phenotype)]
...
G_W2, G_b2, G_W3, G_b3 = [tf.multiply(tensor, tf.constant(mask)) for tensor, mask in zip([G_W2, G_b2, G_W3, G_b3], phenotype)]
